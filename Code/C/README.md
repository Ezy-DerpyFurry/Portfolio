I am infact updating this to support a much bigger terminal ui to include extra functions needed such as clearing terminal easily
Executing command lines while in the ui so you don't need to close it to execute console commands while running it.
